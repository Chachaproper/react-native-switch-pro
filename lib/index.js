...
export default class extends Component {
  static propTypes = {
    ...
    circleInnerComponent: PropTypes.func
  }
  ...
  static defaultProps = {
    ...
    circleInnerComponent: () => null,
    onAsyncPress: (callback) => {callback(true)}
  }

  constructor (props, context) {
    super(props, context)
    const { width, circleSize, value } = props

    this.offset = width - circleSize - 2
    this.handlerSize = circleSize
